'use client'
// Assure que ce composant s'exécute uniquement côté client, permettant l'accès à des APIs telles que localStorTelephone.
import { useState } from 'react'; // Importe useState de React pour créer des états locaux.
import styles from './Musique.module.css'; // Importe les styles spécifiques au composant Musique.
